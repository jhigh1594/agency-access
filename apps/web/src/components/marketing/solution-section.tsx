    ...
    <section className="py-16 pb-32 sm:py-20 sm:pb-28 md:py-24 md:pb-32 lg:py-28 xl:py-32 overflow-hidden bg-white">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col lg:flex-row items-center gap-12 sm:gap-12 md:gap-16 lg:gap-24">
          {/* Left: Isometric Layers - Brutalist styling */}
          <div className="flex-1 relative w-full h-[450px] xs:h-[400px] sm:h-[480px] md:h-[560px] lg:h-[500px] order-2 lg:order-1 mt-8 sm:mt-0">
            <div className="absolute inset-0 flex items-center justify-center">
              ...
              <m.div
                ...
                viewport={{ once: true }}
                className="absolute w-40 h-52 xs:w-48 xs:h-60 sm:w-64 sm:h-80 bg-gray-100 border-2 border-black rounded-none shadow-[4px_4px_0px_#000] translate-x-4 xs:translate-x-6 sm:translate-x-10"
              />
              ...
              <m.div
                ...
                className="absolute w-40 h-52 xs:w-48 xs:h-60 sm:w-64 sm:h-80 bg-white border-2 border-black rounded-none shadow-[6px_6px_0px_#000] translate-x-2 xs:translate-x-3 sm:translate-x-5"
              />
              ...
              <m.div
                ...
                className="absolute w-40 h-52 xs:w-48 xs:h-60 sm:w-64 sm:h-80 bg-white border-2 border-black rounded-none shadow-brutalist-xl z-10 flex flex-col p-3 xs:p-4 sm:p-6 gap-1.5 xs:gap-2 sm:gap-4"
              >
                <div className="h-2.5 xs:h-3 sm:h-4 w-3/4 bg-gray-100 rounded-none" />
                <div className="h-16 xs:h-20 sm:h-32 w-full bg-teal/10 border border-black rounded-none" />
                <div className="space-y-1 xs:space-y-1.5 sm:space-y-2">
                  <div className="h-1.5 xs:h-2 sm:h-3 w-full bg-gray-100 rounded-none" />
                  <div className="h-1.5 xs:h-2 sm:h-3 w-5/6 bg-gray-100 rounded-none" />
                </div>
              ...
              {stats.map((stat, i) => (
                ...
                >
                  <div className="flex items-center justify-center flex-shrink-0">
                    <stat.icon size={14} className="text-white xs:hidden" />
                    <stat.icon size={16} className="text-white hidden xs:block sm:hidden" />
