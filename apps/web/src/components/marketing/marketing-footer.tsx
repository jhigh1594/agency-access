...
export function MarketingFooter() {
  return (
    <footer className="bg-card py-16 sm:py-20 md:py-24 border-t border-border">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row justify-between gap-8 sm:gap-12">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-6 sm:gap-8 md:gap-12 w-full md:w-auto">
            <div>
              <h4 className="font-bold uppercase tracking-widest text-xs mb-4 sm:mb-6">Product</h4>
            ...
            <div>
              <h4 className="font-bold uppercase tracking-widest text-xs mb-4 sm:mb-6">Company</h4>
              <ul className="space-y-3 sm:space-y-4 text-sm text-muted-foreground">
            ...
            <div>
              <h4 className="font-bold uppercase tracking-widest text-xs mb-4 sm:mb-6">Legal</h4>
              <ul className="space-y-3 sm:space-y-4 text-sm text-muted-foreground">
        ...
        <div className="mt-12 sm:mt-16 md:mt-24 pt-6 sm:pt-8 border-t border-border flex flex-col sm:flex-row justify-between items-center gap-4 text-center sm:text-left">
