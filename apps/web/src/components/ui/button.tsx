...
export const Button = forwardRef<HTMLButtonElement, ButtonProps>(
  (
    ...
    const variantStyles: Record<NonNullable<ButtonProps['variant']>, string> = {
      ...
      secondary: 'bg-card text-foreground border-2 border-border hover:bg-accent/20 hover:border-accent hover:translate-y-[-2px] active:scale-95 shadow-brutalist transition-transform',
